...
#        expand(pf('atac814_{stage1}_vs_{stage2}', 'tg_se.bwa_se.rm_unmapped.rm_chrM.rm_blacklist.rm_q10.macs2_se_extsize150_shiftm75_keepdup_all_noSPMR.atac_nanmax.atac814_deseq2x2', '_deseq.txt', 'atac814'), stage1=con#fig['stages'], stage2=config['stages'])
