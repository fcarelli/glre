...
rule yapc_spr_pe:
    ...
    shell:
        'yapc {wildcards.prefix}/{wildcards.step}.yapc_spr_pe/{wildcards.sample}.{wildcards.step}.yapc_spr_pe {wildcards.sample} {input[0]} {input[1]} {params.yapc_args}'
...
rule yapc_spr_se:
    ...
    shell:
        'yapc {wildcards.prefix}/{wildcards.step}.yapc_spr_se/{wildcards.sample}.{wildcards.step}.yapc_spr_se {wildcards.sample} {input[0]} {input[1]} {params.yapc_args}'
