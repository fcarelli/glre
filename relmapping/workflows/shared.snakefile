...
rule ce11:
    output:
        ...
        #'shared/ce11.1.ebwt',
    shell: '''
        wget ftp://ftp.wormbase.org/pub/wormbase/species/c_elegans/sequence/genomic/c_elegans.PRJNA13758.WS275.genomic.fa.gz -O shared/ce11.fa.gz
        gunzip shared/ce11.fa.gz
        samtools faidx shared/ce11.fa
        cut -f1,2 shared/ce11.fa.fai > shared/ce11.chroms
...
rule CB4:
    ...
    output:
        ...
        'shared/cb4.fa.sa',
    shell: '''
        wget ftp://ftp.wormbase.org/pub/wormbase/species/c_briggsae/sequence/genomic/c_briggsae.PRJNA10731.WS275.genomic.fa.gz -O shared/cb4.fa.gz
        gunzip shared/cb4.fa.gz
