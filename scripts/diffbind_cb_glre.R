...
samplesID_all=list.files("relmapping/atac/tg_se.bwa_se_cb4.rm_unmapped.rm_contigs_cb4.rm_q10")
Peaks="relmapping/annot_cb/reg_elements_cb.bed"
...
bamReads=paste("relmapping/atac/tg_se.bwa_se_cb4.rm_unmapped.rm_contigs_cb4.rm_q10", samplesID_all, sep="/")
...
write.table(df, "RE_annotation/reg_elements_all.briggsae.gl_specific.diffbind.bed", quote = F, sep = "\t", row.names = F, col.names = F)
